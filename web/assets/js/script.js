...
$(document).ready(function() {
    $('.nav li.dropdown').hover(function() {
        //*GP* $(this).addClass('open');
    }, function() {
        //*GP* closeMenu()
    });
});

function closeMenu() { setTimeout(function() {$('#servicesMenu').removeClass('open');}, 750); }
function openMenu() {$('#servicesMenu').addClass('open');}
...
function mapInit() {
    ...
    var styles =   [
        ...
        // put your locations lat and long here 48.857608,2.332762
        lat = 46.815171,
        lng = -71.22158,
