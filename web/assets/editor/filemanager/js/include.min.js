...
function swipe_reaction(e,t,n,r,i){
    ...
    if($("#view").val()==0){
        if(s.attr("toggle")==1){
            s.attr("toggle",0);
            s.animate({top:"0px"},{queue:false,duration:300})
        }
        else{
            s.attr("toggle",1);
            s.animate({top:"-30px"},{queue:false,duration:300})
        }
    }
}
function apply(e,t){
    ...
    if($.inArray(o,ext_img)>-1){
        ...
        if($.inArray(o,f)>-1){
            ...
            if($.inArray(o,a)>-1){
                if(o=="mp3"){o="mpeg"}u='<audio controls src="'+i+r+e+'" type="audio/'+o+'">'+s+"</audio>"
            }else{
