<?php
    ...
    class staticController extends Controller
    {
        public function init()
        {
            ...
            $lngs = Cms::getOption('languages');
            $this->view->cms_languages = !empty($lngs) ? explode(',', $lngs) : array('fr');
        ...
        public function itemAction()
        {
            ...
            if (File::exists(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . Inflector::lower($type) . '-list.phtml')) {
                $this->view->viewRenderer(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . Inflector::lower($type) . '-list.phtml');
            } else {
        ...
        public function itemAddAction()
        {
            ...
            if (File::exists(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . Inflector::lower($type) . '-add.phtml')) {
                $this->view->viewRenderer(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . Inflector::lower($type) . '-add.phtml');
            } else {
                $this->view->viewRenderer(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . 'default-add.phtml');
            }
        ...
        public function itemViewAction()
        {
            ...
            if (File::exists(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . Inflector::lower($type) . '-view.phtml')) {
                $this->view->viewRenderer(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . Inflector::lower($type) . '-view.phtml');
            } else {
                $this->view->viewRenderer(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . 'default-view.phtml');
            }
        ...
        public function itemEditAction()
        {
            ...
            $item   = Data::getById($type, $id);
            if (File::exists(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . Inflector::lower($type) . '-edit.phtml')) {
                $this->view->viewRenderer(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . Inflector::lower($type) . '-edit.phtml');
            } else {
                $this->view->viewRenderer(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . 'default-edit.phtml');
            }
        ...
        public function itemDuplicateAction()
        {
            ...
            $item   = Data::getById($type, $id);
            if (File::exists(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . Inflector::lower($type) . '-duplicate.phtml')) {
                $this->view->viewRenderer(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . Inflector::lower($type) . '-duplicate.phtml');
            } else {
                $this->view->viewRenderer(APPLICATION_PATH . DS . SITE_NAME . DS . 'modules' . DS . 'admin' . DS . 'views' . DS . 'scripts' . DS . 'static' . DS . 'default-duplicate.phtml');
            }
